  ...
  render() {
    return html`
      ...
      <div id="card-container" >
        <small-card img="/battle-trophy.png" text="Extension" type="extension"></small-card>
        <small-card img="/user-experience.png" text="Mobile" type="mobile" ></small-card>
      </div>
    `;
  }
}
